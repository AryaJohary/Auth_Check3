defmodule AuthCheck3.Accounts.User do
  use Ecto.Schema
...
# here, we don't have password but only email
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, AuthCheck3.Repo)
  ...
  """
  def valid_password?(%AuthCheck3.Accounts.User{hashed_password: hashed_password}, password)
