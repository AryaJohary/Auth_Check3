defmodule AuthCheck3Web.UserRegistrationLive do
  use AuthCheck3Web, :live_view

  alias AuthCheck3.Accounts
  alias AuthCheck3.Accounts.User
  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-sm">
      ...
      <.google_auth_button navigate={~p"/auth/google"}> Register via Google</.google_auth_button>
      <.simple_form
        for={@form}
